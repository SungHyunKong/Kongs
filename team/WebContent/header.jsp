...
<%@ page import="com.ts.controller.*" %>
<%@ page import="com.ts.frontcontroller.*" %>
<%@ page import="com.ts.model.*" %>
	...
	<nav class="navbar navbar-expand-lg main-navbar">
				...
				<ul class="navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
						...
						<div class="d-sm-none d-lg-inline-block">${name} 님 안녕하세요.</div></a>
						
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">로그인되었습니다</div>
							<a href="memberDetailAction.me?member_id=" class="dropdown-item has-icon">
							...
							<a href="logout.jsp" class="dropdown-item has-icon text-danger"> <i
